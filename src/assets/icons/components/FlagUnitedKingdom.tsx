...
const SvgFlagUnitedKingdom = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <path d={'M0 0h24v24H0z'} fill={'url(#flag-united-kingdom_svg__a)'} />
    <defs>
      <pattern
        height={1}
        ...
        width={1}
      >
        <use transform={'scale(.01389)'} xlinkHref={'#flag-united-kingdom_svg__b'} />
      </pattern>
      <image
        height={72}
